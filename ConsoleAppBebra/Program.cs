...
namespace Монополия
{
    internal class Program
    {
        ...
        public static string[,] chance = new string[20, 3]
        {
            ...
            {"Событие", "У вас День рождение. Пусть все заплатят денег","100"},
        ...
        static async void Main2()
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("Нажмите пробел если хотите сделать что то еще\nНажмите любую клавишу чтобы продолжить...");
                ConsoleKeyInfo a;
                try
                {
                    a = Console.ReadKey();
                ...
                if (a.Key == ConsoleKey.Spacebar)
                {
                    ...
                    Console.WriteLine("Выберите номер улицы на которую хотите поставить дом");
                    ...
                    if (Convert.ToInt32(mass[mass.Length - 1]) * z > curentPlayer.Money)
                    {
                        Console.WriteLine("Денег недостаточно. Повторите в следующем ходу");
                    }
                    else
                    {
                        curentPlayer.Money = Convert.ToInt32(mass[mass.Length - 1]) * z;
                        info[y, 7] += z;
                    }
        ...
        public static Players Chance(Players player)
        {
            ...
            int ranChance = rnd.Next(0, chance.Length);
            Console.WriteLine($"Карта {chance[ranChance, 0]}. {chance[ranChance, 1]}. {chance[ranChance, 2]} Долларов рублей");
            if (chance[ranChance, 0] == "Событие")
            {
                if (chance[ranChance, 2] == "-1")
                {
                    player = GoToPole(player, "7,7");
                    return player = GoToPole(player, "7,7");
                }
                if (chance[ranChance, 2] == "-2")
                {
                    player.Inventary.Add("Вы можете выйти из тюрьмы");
                    return player;
                }
                if (chance[ranChance, 2] == "-3")
                {
            ...
            else if (chance[ranChance, 0] == "Приз")
            {
                player.Money += Convert.ToDouble(chance[ranChance, 2]);
            }
            else
            {
                player.Money -= Convert.ToDouble(chance[ranChance, 2]);
        ...
        {
            if (player.Money < Convert.ToInt32(info[id, 1]))
            {
            ...
            if (h.ToLower() == "да" ? true : false)//Тотальный кайф
            {
        ...
        public static Players Renta(Players player, int id)
        {
            ...
            if (y == 3)
            {
                ...
                {
                    int houses = Convert.ToInt32(info[id, 7]);
            ...
            Console.WriteLine($"Вы заплатили ренту игроку - {rentSum}");
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                Console.ReadKey(); Console.ReadKey(); Console.ReadKey(); Console.ReadKey();//знатный рофл
            }
        }
